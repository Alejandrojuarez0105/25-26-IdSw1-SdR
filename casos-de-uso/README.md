...
| :-----------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| **Generador** |         - Procesar Solicitud de Generación<br>- Generar Fechas de Exámenes<br>- Revisar Posibles Conflictos<br>- Aplicar Correcciones Solicitadas<br>- Finalizar Asignación de Exámenes         | Procesar Generación **include** Generar Fechas<br>Generar Fechas **include** Revisar Conflictos<br>Revisar Conflictos **extend** Finalizar Asignación<br>Aplicar Correcciones **extend** Generar Fechas | Como funciona:<br><br>_ Se basa en los estados del generador (PendienteDeAsignar, Asignando, PendienteDeRevisión, Finalizado)<br>_ iniciarAsignación() → CdU: Procesar Solicitud de Generación / Generar Fechas de Exámenes<br>_ fechasGeneradas() → CdU: Revisar Posibles Conflictos<br>_ solicitarCorrección() → CdU: Aplicar Correcciones Solicitadas<br>\* aprobarAsignación() → CdU: Finalizar Asignación |
